    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        <Card
          ...
          description="dfjgdfjgdrmjmncv b vjdfvkduhidrk bvkjdhkif uvhiderhoiv dfbvkudhfvldhivhdkiv kidhgirdhgie kdighireghoie dhgihugire ghrkihgkierhbpa'fi-[wegiegh cvodugp0euihkid"
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card title="Development & Lunch" icon={<AceternityIcon order="Phase 3" />}
        description="dfjgdfjgdrmjmncv b vjdfvkduhidrk bvkjdhkif uvhiderhoiv dfbvkudhfvldhivhdkiv kidhgirdhgie kdighireghoie dhgihugire ghrkihgkierhbpa'fi-[wegiegh cvodugp0euihkid"
        >
          <CanvasRevealEffect
            animationSpeed={3}
